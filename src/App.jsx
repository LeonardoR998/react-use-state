import React, { useState } from "react"; // Importa React e l'hook useState per gestire lo stato
import ButtonList from "./components/ButtonList"; // Importa il componente ButtonList
...
const App = () => {
  // Stato per memorizzare il linguaggio attualmente selezionato, il primo nell'array `languages`
  const [selectedLanguage, setSelectedLanguage] = useState(languages[0]);

  return (
    <div className="container py-4">
      <h1 className="mb-4">Seleziona un linguaggio web</h1>

      {/* Componente che mostra i pulsanti */}
      {/* Passa la funzione setSelectedLanguage come prop onSelect per aggiornare lo stato */}
      <ButtonList languages={languages} onSelect={setSelectedLanguage} />

      {/* Componente che mostra il titolo e la descrizione  */}
      {/* Utilizza lo stato selectedLanguage per determinare il contenuto della card */}
      <Card
